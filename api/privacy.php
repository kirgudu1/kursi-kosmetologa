...
<div class="li">1.2. Настоящая политика Оператора в&nbsp;отношении обработки персональных данных (далее&nbsp;&mdash; Политика) применяется ко&nbsp;всей информации, которую Оператор может получить о&nbsp;посетителях веб-сайта&nbsp;<span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"><?php echo SITE_URL; ?></span>.</div>
</div>
</div>
</div>
<div class="row mb-4">
...
<div class="li">2.3. Веб-сайт&nbsp;&mdash; совокупность графических и&nbsp;информационных материалов, а&nbsp;также программ для ЭВМ и&nbsp;баз данных, обеспечивающих их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу&nbsp;<span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"><?php echo SITE_URL; ?></span>.</div>
...
<div class="li">2.8. Персональные данные&nbsp;&mdash; любая информация, относящаяся прямо или косвенно к&nbsp;определенному или определяемому Пользователю веб-сайта&nbsp;<span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"><?php echo SITE_URL; ?></span>.</div>
...
<div class="li">2.10. Пользователь&nbsp;&mdash; любой посетитель веб-сайта&nbsp;<span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field"><?php echo SITE_URL; ?></span>.</div>
...
<div class="li">12.3. Актуальная версия Политики в&nbsp;свободном доступе расположена в&nbsp;сети Интернет по&nbsp;адресу&nbsp;<span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field"><?php echo SITE_URL; ?>privacy.html</span>.</div>
</div>


<div class="row mb-4">
  <div class="col">
    <h5>13. Использование файлов cookie</h5>
    <div class="ol">
      <div class="li">13.1. Файлы cookie представляют собой небольшие фрагменты данных, которые сохраняются на устройстве Пользователя и используются для улучшения взаимодействия с сайтом.</div>
      <div class="li">13.2. Сайт использует cookie для анализа поведения пользователей, запоминания пользовательских предпочтений и предоставления релевантной информации.</div>
      <div class="li">13.3. Некоторые cookie могут устанавливаться сторонними сервисами, такими как системы аналитики, рекламные платформы и социальные сети. Такие данные обрабатываются в соответствии с политикой конфиденциальности соответствующих сервисов.</div>
      <div class="li">13.4. Пользователь имеет право ограничить или отключить использование cookie в настройках своего браузера. Однако это может повлиять на доступность и корректную работу некоторых функций сайта.</div>
    </div>
  </div>
</div>
